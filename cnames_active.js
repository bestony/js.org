 ...
 * ***********
 *
 * KEY:         The subdomain you request (e.g.: "foo" would give the custom
 *domain "foo.js.org").
 *
 * VALUE:       The regular domain provided by GitHub (e.g.: "foo.github.io" for
 *a User-/Organization Page or "foo.github.io/bar" for a Project Page).
 *
 * CLOUDFLARE:  JS.ORG uses CloudFlare as its DNS. By default, CloudFlare
 *proxies all requests to your subdomain to get SSL support (https://foo.js.org)
 *and make use of browser caching with a TTL of 30 min. But you can opt-out from
 *this and make Cloudflare forward all requests directly to GitHub. Just add
 *'//noCF' in the line of your requested subdomain to give us a hint. (all the
 *lines marked with '//noCF?' are from a time when a requester had to explicitly
 *opt-in; see: https://github.com/js-org/js.org/issues/554)
 *
 * IMPORTANT:   To authorize yourself as the owner of the GitHub Page you must
 *have added a valid CNAME file (with the requested domain, e.g.: "foo.js.org")
 *to your repository. The requested subdomain must match either your GitHub
 *username or the name of your project repository. Exceptions are possible for
 *the sake of clarity (e.g. if your project has the name "foojs" you can request
 *"foo"). Before you start a request for your personal fork of "react" or "vue"
 *you should read the section "naming conflicts" in the wiki!
 *
 * NOTICE:      Please follow the format set by everyone else in this file.
 *Entries should use double quotes, with space between the colon (after the key)
 *and the value and should always be in alphabetical order. Each line apart from
 *the very last entry should have a comma after it to ensure this file is valid
 *syntax.
 *
 *              BECAUSE OF THE RISK OF ABUSE, I´M NOT ACCEPTING REQUESTS FOR
 *PAGES WITHOUT REASONABLE CONTENT!
 */
...
var cnames_active = {
  ...
  "algebra" :
      "nicolewhite.github.io/algebra.js", // noCF? (don´t add this in a new PR)
  ...
  "angular-jsf" :
      "json-schema-faker.github.io/angular-jsf", // noCF? (don´t add this in a
                                                 // new PR)
  "angular-uikit" : "whoisjorge.github.io/angular-uikit",
  "angular2in1" : "angular2in1.github.io/angular2in1js",    // noCF
  "angularstompdk" : "davinkevin.github.io/AngularStompDK", // noCF? (don´t add
                                                            // this in a new PR)
  ...
  "annotate" : "taitems.github.io/web-pdf-annotation", // noCF? (don´t add this
                                                       // in a new PR)
  "annoyingmouse" :
      "annoyingmouse.github.io", // noCF? (don´t add this in a new PR)
  ...
  "apicluster" :
      "ramsunvtech.github.io/apicluster", // noCF? (don´t add this in a new PR)
  "aping" :
      "johnnythetank.github.io/apiNG", // noCF? (don´t add this in a new PR)
  "aplayer" : "diygod.github.io/APlayer",
  "apod" : "marcosflorencio.github.io/angular-apod", // noCF? (don´t add this in
                                                     // a new PR)
  ...
  "argo" :
      "albertosantini.github.io/argo", // noCF? (don´t add this in a new PR)
  ...
  "artery" :
      "arteryjs.github.io/gh-pages", // noCF? (don´t add this in a new PR)
  ...
  "astral" :
      "espinielli.github.io/astraljs", // noCF? (don´t add this in a new PR)
  "astrobench" :
      "kupriyanenko.github.io/astrobench", // noCF? (don´t add this in a new PR)
  ...
  "backlog" : "backlog-js.github.io/backlog.js.org", // noCF? (don´t add this in
                                                     // a new PR)
  "backstage" : "backstagejs.github.io/backstage",
  "backwards-n" : "backwards-n.github.io",
  "badger" :
      "just-glue-it.github.io/badger", // noCF? (don´t add this in a new PR)
  ...
  "begin" : "advanced-webapps-class.github.io/begin", // noCF? (don´t add this
                                                      // in a new PR)
  ...
  "bind-action-dispatchers" :
      "cchamberlain.github.io/bind-action-dispatchers", // noCF? (don´t add this
                                                        // in a new PR)
  ...
  "bodybuilder" :
      "danpaz.github.io/bodybuilder", // noCF? (don´t add this in a new PR)
  ...
  "bootstrap-confirmation" :
      "mistic100.github.io/Bootstrap-Confirmation", // noCF? (don´t add this in
                                                    // a new PR)
  ...
  "brandonmerritt" :
      "brandonmerritt.github.io", // noCF? (don´t add this in a new PR)
  "brasil" : "javascriptbrasil.github.io",
  "bricklayer" :
      "ademilter.github.io/bricklayer", // noCF? (don´t add this in a new PR)
  ...
  "bunyan-fork" : "cchamberlain.github.io/bunyan-fork", // noCF? (don´t add this
                                                        // in a new PR)
  "bunyan-pmx" :
      "cchamberlain.github.io/bunyan-pmx", // noCF? (don´t add this in a new PR)
  "bunyan-serializer" :
      "cchamberlain.github.io/bunyan-serializer", // noCF? (don´t add this in a
                                                  // new PR)
  "burst" : "hugeen.github.io/burst", // noCF? (don´t add this in a new PR)
  "bustime" :
      "agarzola.github.io/bustime", // noCF? (don´t add this in a new PR)
  "buttermilk" : "buttermilk.netlify.com",
  "c" : "cocobear.github.io",
  "c-3po" : "ttag-org.github.io/c-3po",
  "cable" :
      "whatgoodisaroad.github.io/cablejs", // noCF? (don´t add this in a new PR)
  "cac" : "cac.netlify.com",
  ...
  "calendarios" :
      "helpdev.github.io/Calendarios", // noCF? (don´t add this in a new PR)
  ...
  "cartodb-demo" :
      "opensas.github.io/cartodb-demo", // noCF? (don´t add this in a new PR)
  ...
  "christo" :
      "christoga.github.io/js-org", // noCF? (don´t add this in a new PR)
  "christopher" : "marekkobida.github.io/christopher",
  "chronos" :
      "espinielli.github.io/chronos", // noCF? (don´t add this in a new PR)
  ...
  "cn.redux" : "camsong.github.io/redux-in-chinese", // noCF? (don´t add this in
                                                     // a new PR)
  ...
  "collegequest" :
      "schoolhouserock.github.io/CollegeQuest", // noCF? (don´t add this in a
                                                // new PR)
  ...
  "comixngn" :
      "seun40.github.io/comix-ngn", // noCF? (don´t add this in a new PR)
  "commandfox" :
      "commandfox.github.io/mc-tools", // noCF? (don´t add this in a new PR)
  ...
  "concursos" :
      "mteyss.github.io/concursos", // noCF? (don´t add this in a new PR)
  "conductor" : "hosting.gitbook.com",
  "consent" : "datamart.github.io/Consent",
  "construyendotrabajo" :
      "mteyss.github.io/construyendotrabajo", // noCF? (don´t add this in a new
                                              // PR)
  "consultant" : "jense5.github.io/consultant",
  "contextify" : "abemedia.github.io/jquery-contextify", // noCF? (don´t add
                                                         // this in a new PR)
  ...
  "cordova-multiplatform-template" :
      "ckgrafico.github.io/Cordova-Multiplatform-Template", // noCF? (don´t add
                                                            // this in a new PR)
  ...
  "country" :
      "growmies.github.io/countryjs", // noCF? (don´t add this in a new PR)
  ...
  "cucumber-mink" :
      "adezandee.github.io/cucumber-mink", // noCF? (don´t add this in a new PR)
  ...
  "date" :
      "matthewmueller.github.io/date", // noCF? (don´t add this in a new PR)
  ...
  "daysfromnow" :
      "pedrokost.github.io/daysfromnow", // noCF? (don´t add this in a new PR)
  ...
  "delegacias-fortaleza" :
      "juliosampaio.github.io/delegacias-fortaleza", // noCF? (don´t add this in
                                                     // a new PR)
  ...
  "detect-resize" : "noderaider.github.io/detect-resize", // noCF? (don´t add
                                                          // this in a new PR)
  ...
  "dgelong" :
      "alexeyraspopov.github.io/dgelong", // noCF? (don´t add this in a new PR)
  ...
  "diffract" :
      "ameyms.github.io/diffract", // noCF? (don´t add this in a new PR)
  "dinesh" :
      "dineshondev.github.io/dinesh", // noCF? (don´t add this in a new PR)
  ...
  "distillery" : "achannarasappa.github.io/distillery", // noCF? (don´t add this
                                                        // in a new PR)
  ...
  "documentation" :
      "documentationjs.github.io", // noCF? (don´t add this in a new PR)
  ...
  "draft" :
      "D1SC0tech.github.io/draft.js", // noCF? (don´t add this in a new PR)
  "drag" :
      "classicoldsong.github.io/Drag.js", // noCF? (don´t add this in a new PR)
  "dragio" : "alexkratky.github.io/Dragio.js",
  "dragon" :
      "sabertazimi.github.io/dragonjs", // noCF? (don´t add this in a new PR)
  ...
  "elf" :
      "mytharcher.github.io/elf.js.org", // noCF? (don´t add this in a new PR)
  ...
  "ember-cli-page-object" :
      "san650.github.io/ember-cli-page-object", // noCF? (don´t add this in a
                                                // new PR)
  "ember-electron" : "felixrieseberg.github.io/ember-electron",
  "emeraldcraftmc" :
      "emeraldcraftmc.github.io", // noCF? (don´t add this in a new PR)
  ...
  "enclave" :
      "eanplatter.github.io/enclave", // noCF? (don´t add this in a new PR)
  ...
  "es.redux" : "sergiodxa.github.io/redux-in-spanish", // noCF? (don´t add this
                                                       // in a new PR)
  "es2015-node" :
      "martinheidegger.github.io/es6modules-nodejs", // noCF? (don´t add this in
                                                     // a new PR)
  "es6-module-seed" : "blackmirror1980.github.io/es6-module-seed",
  "es6-tween" : "tweenjs.github.io/es6-tween",
  "escape" :
      "licshee.github.io/Escape.js", // noCF? (don´t add this in a new PR)
  "esfx" : "esfx.github.io",
  "esper" : "codecombat.github.io/esper.js",
  "ethavatar" : "filips123.github.io/EthAvatar.JS",
  "euc" : "wnda.github.io/euc",
  "euclid" :
      "anandthakker.github.io/euclid", // noCF? (don´t add this in a new PR)
  "eval" : "jshawl.github.io/eval",    // noCF? (don´t add this in a new PR)
  "event-storage" : "albe.github.io/node-event-storage",
  "eventstore" :
      "adrai.github.io/node-eventstore", // noCF? (don´t add this in a new PR)
  ...
  "exbars" :
      "youssefkababe.github.io/exbars", // noCF? (don´t add this in a new PR)
  ...
  "extraction" :
      "rse.github.io/extraction", // noCF? (don´t add this in a new PR)
  ...
  "farfetchd" : "achannarasappa.github.io/farfetchd", // noCF? (don´t add this
                                                      // in a new PR)
  "farzad" : "wikiweb.github.io/farzad",
  "faucet" : "faucetjs.github.io",
  "faux" : "fauxOS.github.io",
  "fcbosque" :
      "cronopio.github.io/fcbosque", // noCF? (don´t add this in a new PR)
  ...
  "fire-hydrant" : "cchamberlain.github.io/fire-hydrant", // noCF? (don´t add
                                                          // this in a new PR)
  ...
  "flowchart" :
      "adrai.github.io/flowchart.js", // noCF? (don´t add this in a new PR)
  ...
  "fluxoff" :
      "kingscott.github.io/flux-off", // noCF? (don´t add this in a new PR)
  ...
  "fortune" :
      "fortunejs.github.io/fortune", // noCF? (don´t add this in a new PR)
  ...
  "freemarker" :
      "ijse.github.io/freemarker.js", // noCF? (don´t add this in a new PR)
  ...
  "gamedevcontestal" :
      "fromdenisvieira.github.io/gamedevcontestal", // noCF? (don´t add this in
                                                    // a new PR)
  ...
  "genpasswd" :
      "exos.github.io/genpasswd", // noCF? (don´t add this in a new PR)
  ...
  "getlink" :
      "ilovecode1.github.io/linkjs", // noCF? (don´t add this in a new PR)
  ...
  "giant-piano" :
      "moroshko.github.io/giant-piano", // noCF? (don´t add this in a new PR)
  ...
  "graphics2d" :
      "keyten.github.io/Graphics2D", // noCF? (don´t add this in a new PR)
  "graphstore" : "besync.github.io/graphstore",
  "grapnel" : "engineeringmode.github.io/Grapnel.js", // noCF? (don´t add this
                                                      // in a new PR)
  ...
  "guillotine" : "matiasgagliano.github.io/guillotine", // noCF? (don´t add this
                                                        // in a new PR)
  "guineapigbot" : "guineapigbot.github.io",
  "guiseek" : "guiseek.github.io", // noCF? (don´t add this in a new PR)
  "gully" :
      "nmabhinandan.github.io/gully", // noCF? (don´t add this in a new PR)
  ...
  "haloapi" : "derflatulator.github.io/haloapi.js", // noCF? (don´t add this in
                                                    // a new PR)
  ...
  "heartseekers" :
      "rajington.github.io/heartseekers", // noCF? (don´t add this in a new PR)
  ...
  "hyperhtml-styleguide" :
      "albertosantini.github.io/hyperhtml-styleguide", // noCF
  ...
  "ip-address" : "beaugunderson.github.io/ip-address", // noCF? (don´t add this
                                                       // in a new PR)
  ...
  "ishan" :
      "ishanthukral.github.io/ishan.js", // noCF? (don´t add this in a new PR)
  "isic" : "isic.github.io/isic-docs",
  "islisp" : "ta2gch.github.io/islisp.js.org",
  "istanbul" : "istanbuljs.github.io",
  "italia" :
      "milano-js.github.io/italia-js",   // noCF? (don´t add this in a new PR)
  ...
  "jacques" :
      "jacquesmarais.github.io/jacques", // noCF? (don´t add this in a new PR)
  "jaibascript" : "vasco3.github.io/jaibascript",
  "jaipur" : "jaipurjs-website-7b695.netlify.com",
  "jakarta" :
      "jakartajs.github.io/jakartajs", // noCF? (don´t add this in a new PR)
  ...
  "jargon" :
      "hugogiraudel.github.io/SJSJ", // noCF? (don´t add this in a new PR)
  "jason" : "limeb.github.io/jason",
  "javali" : "diogomoretti.github.io/javali",
  "javascript-kitchen" : "jskitchen.github.io",
  "jbone" :
      "kupriyanenko.github.io/jbone", // noCF? (don´t add this in a new PR)
  ...
  "kalm" :
      "fed135.github.io/kalm.github.io", // noCF? (don´t add this in a new PR)
  ...
  "labelauty" : "fntneves.github.io/jquery-labelauty", // noCF? (don´t add this
                                                       // in a new PR)
  ...
  "leste" :
      "atwood-cai.github.io/leste.js", // noCF? (don´t add this in a new PR)
  ...
  "localsync" :
      "noderaider.github.io/localsync", // noCF? (don´t add this in a new PR)
  ...
  "martingollogly" :
      "martingollogly.github.io", // noCF? (don´t add this in a new PR)
  ...
  "matthias-schuetz" :
      "matthias-schuetz.github.io", // noCF? (don´t add this in a new PR)
  "mauricio" : "mauricionobrega.github.io/www",
  "maxnachlinger" :
      "maxnachlinger.github.io", // noCF? (don´t add this in a new PR)
  ...
  "meiosis" :
      "foxdonut.github.io/meiosis", // noCF? (don´t add this in a new PR)
  ...
  "minigrid" :
      "henriquea.github.io/minigrid", // noCF? (don´t add this in a new PR)
  ...
  "mithril-ja" :
      "shibukawa.github.io/mithril-ja", // noCF? (don´t add this in a new PR)
  ...
  "momentum" :
      "wemakeweb.github.io/momentum", // noCF? (don´t add this in a new PR)
  ...
  "murder" :
      "rolandpoulter.github.io/murder", // noCF? (don´t add this in a new PR)
  ...
  "nanimation" : "imthenachoman.github.io/nAnimation", // noCF? (don´t add this
                                                       // in a new PR)
  ...
  "ng-wig" :
      "stevermeister.github.io/ngWig", // noCF? (don´t add this in a new PR)
  ...
  "noted" :
      "carter-slade.github.io/Noted-", // noCF? (don´t add this in a new PR)
  ...
  "nsptiles" :
      "imthenachoman.github.io/nSPTiles", // noCF? (don´t add this in a new PR)
  ...
  "objectmodel" :
      "sylvainpolletvillard.github.io/ObjectModel", // noCF? (don´t add this in
                                                    // a new PR)
  ...
  "pastebin-alert" :
      "ramadhanamizudin.github.io/pastebin-alert.js", // noCF? (don´t add this
                                                      // in a new PR)
  "pathtrace" :
      "kovacsv.github.io/WebGLPathTrace", // noCF? (don´t add this in a new PR)
  ...
  "pdfutils" :
      "gottox.github.io/node-pdfutils", // noCF? (don´t add this in a new PR)
  "pdp-elements" :
      "go4cas.github.io/pdp_elements", // noCF? (don´t add this in a new PR)
  ...
  "penn-sdk" :
      "pennlabs.github.io/penn-sdk-node", // noCF? (don´t add this in a new PR)
  "pentris" :
      "justinjc.github.io/pentris2", // noCF? (don´t add this in a new PR)
  ...
  "photo-sphere-viewer" :
      "mistic100.github.io/Photo-Sphere-Viewer", // noCF? (don´t add this in a
                                                 // new PR)
  "phx" : "phxjs.github.io",
  ...
  "pixelart" :
      "meriadec.github.io/PixelartJS", // noCF? (don´t add this in a new PR)
  "pixxel" : "pixxel.github.io",
  "plait" : "wildlyinaccurate.github.io/plait",
  "plan" : "agauniyal.github.io/plan",
  "planisphere" : "dai-shi.github.io/planisphere-site", // noCF? (don´t add this
                                                        // in a new PR)
  ...
  "pnpm" : "pnpm.github.io",
  "poegems" :
      "max-arias.github.io/poeGems", // noCF? (don´t add this in a new PR)
  ...
  "polythene" :
      "arthurclemens.github.io/Polythene", // noCF? (don´t add this in a new PR)
  "pomidorus" : "tatyshev.github.io/pomidorus",
  "popcorn-api" : "nirewen.github.io/popcorn-api",
  "popper" : "fezvrasta.github.io/popper.js",
  "porter" :
      "ahopkins.github.io/porterjs", // noCF? (don´t add this in a new PR)
  ...
  "querybuilder" :
      "mistic100.github.io/jQuery-QueryBuilder", // noCF? (don´t add this in a
                                                 // new PR)
  ...
  "quiz-app" :
      "odevlord.github.io/Quiz-App", // noCF? (don´t add this in a new PR)
  "quotes" : "sawyerbx.github.io/quotes",
  "r" : "r-js.github.io",
  "ractive" : "ractivejs.github.io",
  "rad" :
      "rapid-application-development-js.github.io/RAD.JS", // noCF? (don´t add
                                                           // this in a new PR)
  "radi" : "radi-js.github.io/radi",
  "radial" :
      "ckgrafico.github.io/radial.js", // noCF? (don´t add this in a new PR)
  "rafaelmangolin" :
      "rafaelMangolin.github.io",         // noCF? (don´t add this in a new PR)
  ...
  "rangeslider" : "andreruffert.github.io/rangeslider.js", // noCF? (don´t add
                                                           // this in a new PR)
  ...
  "react-autosuggest" :
      "moroshko.github.io/react-autosuggest", // noCF? (don´t add this in a new
                                              // PR)
  "react-autowhatever" :
      "moroshko.github.io/react-autowhatever", // noCF? (don´t add this in a new
                                               // PR)
  ...
  "react-easy-swipe" :
      "leandrowd.github.io/react-easy-swipe", // noCF? (don´t add this in a new
                                              // PR)
  ...
  "react-responsive-carousel" :
      "leandrowd.github.io/react-responsive-carousel", // noCF? (don´t add this
                                                       // in a new PR)
  ...
  "reactdesktop" : "gabrielbull.github.io/react-desktop", // noCF? (don´t add
                                                          // this in a new PR)
  ...
  "realtime" :
      "datamcfly.github.io/realtimejs", // noCF? (don´t add this in a new PR)
  ...
  "redis" :
      "noderedis.github.io/node_redis", // noCF? (don´t add this in a new PR)
  ...
  "redux-undo" :
      "omnidan.github.io/redux-undo", // noCF? (don´t add this in a new PR)
  "redux-webpack-boilerplate" :
      "cchamberlain.github.io/redux-webpack-boilerplate", // noCF? (don´t add
                                                          // this in a new PR)
  "reduxible" :
      "pitzcarraldo.github.io/reduxible", // noCF? (don´t add this in a new PR)
  "refract" : "hosting.gitbook.com",
  "refraction" :
      "mbasso.github.io/refraction", // noCF? (don´t add this in a new PR)
  ...
  "relate" :
      "jakelazaroff.github.io/relate", // noCF? (don´t add this in a new PR)
  ...
  "repackage" :
      "cchamberlain.github.io/repackage", // noCF? (don´t add this in a new PR)
  ...
  "restjs" :
      "daviesgeek.github.io/restjs", // noCF? (don´t add this in a new PR)
  ...
  "sass" : "medialize.github.io/playground.sass.js", // noCF? (don´t add this in
                                                     // a new PR)
  "satont" : "satont.github.io",
  "saulosantiago" :
      "saulosilva.github.io", // noCF? (don´t add this in a new PR)
  ...
  "segoe-mdl2-css" :
      "ckgrafico.github.io/Segoe-mdl2-assets-css", // noCF? (don´t add this in a
                                                   // new PR)
  "select_io" :
      "selaromi.github.io/select_io", // noCF? (don´t add this in a new PR)
  "selectors" : "selectors.github.io/selectors.js",
  "selectric" : "lcdsantos.github.io/jQuery-Selectric", // noCF? (don´t add this
                                                        // in a new PR)
  ...
  "serializer" :
      "haircvt.github.io/serializerjs", // noCF? (don´t add this in a new PR)
  ...
  "shortquery" : "s--minecraft.gitbooks.io/shortquery-js", // noCF? (don´t add
                                                           // this in a new PR)
  ...
  "sirkit" : "seckwei.github.io/SirKit_CircuitSim", // noCF? (don´t add this in
                                                    // a new PR)
  ...
  "social-likes" :
      "sapegin.github.io/social-likes", // noCF? (don´t add this in a new PR)
  "social-likes-next" :
      "sapegin.github.io/social-likes-next", // noCF? (don´t add this in a new
                                             // PR)
  ...
  "spectragram" :
      "adrianengine.github.io/jquery-spectragram", // noCF? (don´t add this in a
                                                   // new PR)
  ...
  "spritesheet" : "arcadiogarcia.github.io/Spritesheet.js", // noCF? (don´t add
                                                            // this in a new PR)
  "spritewerk" :
      "bildepunkt.github.io/spritewerk", // noCF? (don´t add this in a new PR)
  ...
  "staticinstance" :
      "staticinstance.github.io", // noCF? (don´t add this in a new PR)
  ...
  "stego" :
      "zeruniverse.github.io/CryptoStego", // noCF? (don´t add this in a new PR)
  "stepan" : "stevermeister.github.io", // noCF? (don´t add this in a new PR)
  "stephenmccall" :
      "stephenmccall.github.io", // noCF? (don´t add this in a new PR)
  ...
  "style" :
      "dhilipsiva.github.io/style.js", // noCF? (don´t add this in a new PR)
  ...
  "supernova" :
      "janbiasi.github.io/supernova", // noCF? (don´t add this in a new PR)
  ...
  "telaviv" :
      "dustin-h.github.io/telaviv", // noCF? (don´t add this in a new PR)
  "telegraf" :
      "telegraf.github.io/telegraf", // noCF? (don´t add this in a new PR)
  "teletype" : "keyvank.github.io/teletype.js",
  "temme" : "shinima.github.io/temme",
  "tequila" : "tequila-js.github.io",
  "terminal" :
      "gottox.github.io/terminal.js", // noCF? (don´t add this in a new PR)
  "testframe" : "testingrequired.github.io/testframe",
  "textillate" :
      "jschr.github.io/textillate", // noCF? (don´t add this in a new PR)
  ...
  "themoviedb" :
      "chrisenytc.github.io/themoviedb", // noCF? (don´t add this in a new PR)
  ...
  "thundercats" : "thundercatsjs.github.io/thundercats", // noCF? (don´t add
                                                         // this in a new PR)
  ...
  "timerizer" :
      "callumacrae.github.io/timerizerJS", // noCF? (don´t add this in a new PR)
  "tina" : "tinajs.github.io/tina",
  "tint" : "tintjs.github.io", // noCF? (don´t add this in a new PR)
  "tinylinux" :
      "e8johan.github.io/tiny-js", // noCF? (don´t add this in a new PR)
  ...
  "ts2jsdoc" :
      "spatools.github.io/ts2jsdoc", // noCF? (don´t add this in a new PR)
  ...
  "upresent" :
      "bobbybee.github.io/uPresent", // noCF? (don´t add this in a new PR)
  ...
  "uvcharts" :
      "imaginea.github.io/uvCharts", // noCF? (don´t add this in a new PR)
  ...
  "validator" :
      "ppoffice.github.io/validator.js", // noCF? (don´t add this in a new PR)
  ...
  "vico" :
      "bohdantkachenko.github.io/vico", // noCF? (don´t add this in a new PR)
  ...
  "vinimdocarmo" :
      "vinimdocarmo.github.com", // noCF? (don´t add this in a new PR)
  ...
  "visualnovel" :
      "selcher.github.io/visualnoveljs", // noCF? (don´t add this in a new PR)
  ...
  "vuongdothanhhuy" :
      "vuongdothanhhuy.github.io", // noCF? (don´t add this in a new PR)
  "vxv" : "vxv.netlify.com",
  ...
  "within" :
      "eric-brechemier.github.io/within", // noCF? (don´t add this in a new PR)
  ...
  "wyfe" :
      "wangyuanstudio.github.io/WYFE", // noCF? (don´t add this in a new PR)
  ...
  "youtube-box" : "lucasmonteverde.github.io/youtube-box", // noCF? (don´t add
                                                           // this in a new PR)
